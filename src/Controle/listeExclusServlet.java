...
@WebServlet("/listeExclusServlet")
public class listeExclusServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public listeExclusServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ae=op.getInfoAbsencesPourListeExclusPourTroisAbsences(nomDepartement);
		ae2=op.getInfoAbsencesPourListeExclusTous(nomDepartement);
...
//-------------------------------------------------------------------------------------------------------
		...
		session.setAttribute("listExclus",aret );
		
		RequestDispatcher disp=request.getRequestDispatcher("/WEB-INF/EspaceChef/listeExclus.jsp");
