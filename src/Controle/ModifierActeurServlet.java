...
/**
 * Servlet implementation class ModifierActeurServlet
 */
@WebServlet("/ModifierActeurServlet")
@MultipartConfig(maxFileSize = 16177216)
public class ModifierActeurServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ModifierActeurServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(admin == null) {
			...
			Administrateur a = new Administrateur(nom,prenom,username,email,en.getMotDePass(),date,ln,sexe,addresse,sf,photoProfil);
		...
		if(chef == null) {
			...
			ChefDepartement c = new ChefDepartement(nom,prenom,username,email,en.getMotDePass(),date,ln,sexe,addresse,sf,photoProfil,grade,departement);
		...
		if(res == null) {
			...
			ResponsableDeFormation r = new ResponsableDeFormation(nom,prenom,username,email,en.getMotDePass(),date,ln,sexe,addresse,sf,photoProfil,grade,new Formation(formation));
			if(oa.modRes(r) == false) {
				oa.addRes(r);
			}
		}
		Enseignent e = new Enseignent(nom,prenom,username,email,date,ln,sexe,addresse,sf,photoProfil,grade);
